...
export default function Search() {
  ...
  return (
    <div className="m-auto max-w-screen-2xl space-y-5 px-16">
      <div className="flex items-center gap-4">
        ...
        >
          <Button
            className="group-data-[type=travel]:bg-black group-data-[type=travel]:text-white rounded-full"
            variant="ghost"
          ...
          <Button
            className="group-data-[type=courier]:bg-black group-data-[type=courier]:text-white rounded-full"
            variant="ghost"
      ...
      <div className="flex gap-4">
        <div className="flex-1 rounded-2xl bg-white px-8 py-2 flex text-sm">
          <div className="flex-1 pr-4 relative">
            ...
            {/* <Input
              id="from"
              className="border-none p-0 focus-visible:ring-transparent rounded-none h-auto"
          ...
          <div className="flex-1 pl-16 pr-4 border-l">
          ...
          <div className="flex-1 pl-16 border-l">
          ...
          {searchType === "courier" && (
            <div className="flex-1 pl-16 border-l">
              ...
              <SingleSelector
                ...
                // onSearch={async (value) => {
                //   const res = await getAirports(value);
                //   return res.data.map((airport) => ({ label: airport.name, value: airport.iata_code }));
                // }}
        ...
        <Button className="h-auto px-8 py-2 text-xl" onClick={() => {}}>
