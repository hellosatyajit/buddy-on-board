...
export default function HelpPage() {
    const [searchType, setSearchType] = useState<'general' | 'buddies'>("general")
    return (
        <div className="px-4 py-8 md:px-16 lg:py-14 2xl:py-16 m-auto max-w-screen-2xl space-y-14">
            <div className="flex justify-between sm:items-center flex-col sm:flex-row gap-2">
                ...
                <div className="flex flex-row justify-start items-center gap-3 sm:gap-6 w-full sm:w-auto">
                    <Link href="/report-issue" className="w-full sm:w-auto p-3 sm:p-4 2xl:py-8 bg-white rounded-2xl shadow-[0px_4px_32px_0px_rgba(0,0,0,0.08)] flex flex-row sm:flex-col justify-start items-start gap-2 sm:gap-3">
                    ...
                    <Link href="/request-issue" className="w-full sm:w-auto p-3 sm:p-4 2xl:py-8 bg-white rounded-2xl shadow-[0px_4px_32px_0px_rgba(0,0,0,0.08)] flex flex-row sm:flex-col justify-start items-start gap-2 sm:gap-3">
                        ...
                        >
                            ...
                            <div className="w-full flex flex-col justify-start items-start gap-4">
                                <div className="w-full flex flex-col justify-center items-start gap-2">
                                    <div className="w-full text-neutral-700 text-xs sm:text-base font-normal">June 15, 2024</div>
                                    ...
                                    <p className="w-full text-[#090909] text-sm sm:text-base font-light">
                                        Have you considered why safety is a priority during your travels?
                                    </p>
                                </div>
                            </div>
                        </Link>
