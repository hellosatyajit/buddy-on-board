          ...
          <div className="self-stretch flex-col justify-start items-start gap-5 flex">
            ...
            <div className="self-stretch justify-start items-center gap-3 inline-flex">
              ...
              <Label htmlFor="stayAnonymous" className="grow shrink basis-0">
                I prefer to remain anonymous (if selected, your personal
                information will not be shared or visible to our support team).
              </Label>
            </div>
            <div className="self-stretch justify-start items-center gap-3 inline-flex">
              <Checkbox
              ...
              <Label htmlFor="agreeToTerms" className="grow shrink basis-0">
                ...
                <Link
                  href="/terms-of-use"
                  className="text-primary text-sm font-bold leading-5 pr-1"
                >
                  Terms of Use
                </Link>
                ...
                <Link
                  href="/privacy-policy"
                  className="text-primary text-sm font-bold leading-5"
                >
                  Privacy Policy
                </Link>
                <span className="text-[#535862] text-sm font-normal leading-[18.20px]">
                  . I understand that agreeing to the Terms is required to
                  complete my registration and use the services.
                </span>
              </Label>
            </div>
          </div>
